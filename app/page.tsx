    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-secondary font-sans">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-background sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <a
            className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-accent-primary px-5 text-primary-foreground transition-colors hover:bg-accent-hover md:w-[158px]"
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-border px-5 transition-colors hover:bg-bg-hover md:w-[158px]"
