...
import { ColumnsContainerPropsSchema as BaseColumnsContainerPropsSchema } from "@/lib/blocks/columns-container";

const BasePropsShape =
  BaseColumnsContainerPropsSchema.shape.props.unwrap().unwrap().shape;
